...
buildDropdownOptions:function(){
    ...
    e.stopPropagation();
    var i=t(e.target).closest("li"),s=i.nextUntil("li.multiselect-group",":not(.disabled)"),l=s.find("input"),o=!0;
    l.each(function(){
    ...
    e.stopPropagation();
    var i=t(e.target).closest("li"),s=i.prevUntil("li.multiselect-group",":not(.disabled)"),l=i.nextUntil("li.multiselect-group",":not(.disabled)"),o=s.find("input"),n=l.find("input"),a=t(e.target).prop("checked");
    o.each(function(){
...
selectAll:function(e,i){
    ...
    var e="undefined"==typeof e?!0:e,s=t("li input[type='checkbox']:enabled",this.$ul),l=s.filter(":visible"),o=s.length,n=l.length;
...
updateSelectAll:function(e){
    if(this.hasSelectAll()){
        var i=t("li:not(.multiselect-item):not(.filter-hidden) input:enabled",this.$ul),s=i.length,l=i.filter(":checked").length,o=t("li.multiselect-all",this.$ul),n=o.find("input");
